...
//V2.0.0-RC8
final class MessageBody: Object, MdkObjectType, MdkDynamicObjectType {
    ...
    //Indexes
    override class func indexedProperties() -> [String] { return ["messageId", "value"] }
